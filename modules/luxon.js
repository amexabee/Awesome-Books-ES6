...
class V {
  ...
  rescale() {
    if (!this.isValid) return this;
    var t = pr(this.normalize().shiftToAll().toObject());
        ...
        (function (e) {
          ...
          if (isNaN(r)) {
            ...
            for (let t = 0; t < e.length; t++) {
              ...
              if (-1 !== e[t].search(Mr.hanidec)) r += Dr.indexOf(e[t]);
              else
                for (const a in Nr) {
                  var [s, i] = Nr[a];
                  s <= n && n <= i && (r += n - s);
...
function _r(s, t) {
  ...
  const e = f.create(t, s),
    r = e.formatDateTimeParts((zr = zr || L.fromMillis(1555555555555)));
  return r.map((e) => {
    {
      var r = s,
        { type: e, value: n } = e;
...
const Ur = [0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334],
  $r = [0, 31, 60, 91, 121, 152, 182, 213, 244, 274, 305, 335];
function Z(t, e) {
  return new y(
    "unit out of range",
...
const mn = { month: 1, day: 1, hour: 0, minute: 0, second: 0, millisecond: 0 },
  fn = {
    weekNumber: 1,
    weekday: 1,
    hour: 0,
...
class L {
  ...
  toISODate({ format: t = "extended" } = {}) {
    return this.isValid ? hn(this, "extended" === t) : null;
  }
  toISOWeekDate() {
  ...
  toISOTime({
    ...
    return this.isValid
      ? (n ? "T" : "") + dn(this, "extended" === i, e, t, r, s)
      : null;
  }
  toRFC2822() {
  ...
  toRelative(t = {}) {
    ...
    return (
      ...
      Sn(e, this.plus(r), { ...t, numeric: "always", units: n, unit: s })
    );
  }
